...
// prim_base (0x1F0-0x1F7), prim_control_base (0x3F6), sec_base (0x170-0x177), sec_control_base (0x376), pass 0 for bus_master_addr
void ide_init(uint32 prim_channel_base_addr, uint32 prim_channel_control_base_addr, uint32 sec_channel_base_addr, uint32 sec_channel_control_addr, uint32 bus_master_addr);
