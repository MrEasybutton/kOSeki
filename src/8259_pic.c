...
//adapted from https://github.com/xing1357/SimpleOS/blob/main/src/8259_pic.c
...
void pic8259_init() {
    ...
    outportb(PIC1_DATA, a1 & ~0x04); // Ensure IRQ 2 is unmasked
